...
var rootCmd = &cobra.Command{
	Use:   "st <sub-command> [options]",
	Short: "Search Stuff quickly",
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&kubeconfig, "kubeconfig", "", "", "for kube_query pluging only default kube config")
